...
const emit = defineEmits(['update:showing-modal'])

const closeModal = () => {
    emit('update:showing-modal', false)
};
...
<template>
  <div class="modal-overlay" id="loginModal" :class="{active: props.showingModal}">
    <div class="login-modal">
      <span class="modal-blob modal-blob-1"></span>
      <span class="modal-blob modal-blob-2"></span>

      <button class="close-modal" id="closeModal" @click="closeModal">
        &times;
      </button>
      <h2 class="modal-title">Iniciar Sesión</h2>

      <form @submit.prevent="verifyModal">
